...
function TotalProgressTasks() {
  return (
    <div className="w-[6vw] px-[0.5vw] py-[1.5vh] bg-gray-300 rounded-xl text-primary duration-200 hover:duration-200 hover:cursor-pointer hover:bg-gray-400 hover:scale-95">
      <div className="flex items-center justify-center">
        <TbProgressBolt className="text-3xl" />
      </div>
