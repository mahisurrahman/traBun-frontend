...
function TotalUnassignedTasks() {
  return (
    <div className="w-[9vw] h-[15vh] px-[0.5vw] py-[1.5vh] bg-gray-200 rounded-xl text-primary duration-200 hover:duration-200 hover:cursor-pointer hover:bg-gray-400 hover:scale-95">
